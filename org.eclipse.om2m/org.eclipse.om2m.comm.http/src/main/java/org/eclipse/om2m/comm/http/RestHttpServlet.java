...
public class RestHttpServlet extends HttpServlet {
    ...
    public static boolean addedFromWeb =false;
    
    public static String obixRepresentation;
    ...
    protected void service(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        try {
            ...
            obixRepresentation = representation;
        } catch (IOException e) {
        ...
        if(restMethod.equalsIgnoreCase("CREATE")) addedFromWeb = true;
    }
    ...
    */
    public static Map<String, List<String>> getParamsFromQuery(String query){
        ...
        LOGGER.info("fewnfhweoufhweoufhweoufhuwehfuwehfuwehfiuwe");
    ...
    */
    ...
    public static String httpRequestToString(String method, String uri, String rep, String auth, String query){
        return "HttpRequest [method=" + method + ", URI=" +uri+ ", representationghhgh=" + rep +
